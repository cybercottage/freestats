...
<div id="main">
    <div id="contents">
        ...
        <TR>
   		...
   		<br />
		<h4>Decoding the values of queue events.</h4>
		<br />
	<table>
	<thead>
	<tr>
		<th class="col0">Event</th><th class="col1">data1</th><th class="col2">data2</th><th class="col3">data3</th>
	</tr>
	</thead>
	<tr>
		<td class="col0">ENTERQUEUE</td><td class="col1"></td><td class="col2">callerid</td><td class="col3">Entry position</td>
	</tr>
	<tr>
		<td class="col0">CONNECT</td><td class="col1">Waiting time</td><td class="col2">uniqueid</td><td class="col3"> </td>
	</tr>
	<tr>
		<td class="col0">COMPLETEAGENT, COMPLETECALLER</td><td class="col1">
Waiting time to answer</td><td class="col2">Call duration</td><td class="col3">Connection position</td>
	</tr>
	<tr>
		<td class="col0">RINGNOANSWER</td><td class="col1">Agent call time (Agent Timeout)</td><td class="col2"> </td><td class="col3"> </td>
	</tr>
    <tr>
		<td class="col0">ABANDON</td><td class="col1">Exit position</td><td class="col2">Entry position</td><td class="col3">Waiting time</td>
	</tr>
	<tr>
		<td class="col0">EXITWITHTIMEOUT</td><td class="col1">Exit position</td><td class="col2">Entry position</td><td class="col3">
Queue timeout</td>
	</tr>
</table>
		<br/>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="frm1" name="frm1" method="post">
	...
	&nbsp;&nbsp;&nbsp;<input type="checkbox" name="alltime" value="alltime">&nbsp;<?php echo "Search all time";?><br/><br/>
