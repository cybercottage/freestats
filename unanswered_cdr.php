...
//   $limit = $_POST['limit'];
//   $_SESSION['freestats']['limit']=$limit;
//} else {
//   $_SESSION['freestats']['limit'] = 100;
//}
...
<select onchange="this.form.submit()" id="pagerows" name="limit">
  <option selected="<?php echo $_SESSION['freestats']['limit'];?>"><?php echo $_SESSION['freestats']['limit'] / 2;?></option>
...
echo "<br />Total found:".$page_rows2."<br />";
