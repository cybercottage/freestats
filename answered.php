...
while ($row = mysqli_fetch_row($res)) {
	...
	} elseif (($row[4] >= 31) && ($row[4] <= 60)) {
		$hold45["$row[1]"] += count($row[4]);
	} elseif (($row[4] >= 61) && ($row[4] <= 90)) {
		$hold60["$row[1]"] += count($row[4]);
	} elseif (($row[4] >= 91) && ($row[4] <= 120)) {
		$hold75["$row[1]"] += count($row[4]);
	} elseif (($row[4] >= 121) && ($row[4] <= 150)) {
...
?>
            ...
            <tr>
                ...
                <tr>
					...
					<TH><?php echo $lang["$language"]['A15sec'] ?></th>
					<TH><?php echo $lang["$language"]['A30sec'] ?></th>
					<TH><?php echo $lang["$language"]['A60sec'] ?></th>
					<TH><?php echo $lang["$language"]['A90sec'] ?></th>
					<TH><?php echo $lang["$language"]['A1205sec'] ?></th>
					<TH><?php echo $lang["$language"]['A150sec'] ?></th>
					<TH><?php echo $lang["$language"]['A150+sec'] ?></th>
